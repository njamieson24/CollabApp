...
<body>
  ...
  <div style="margin-left: 4vh; margin-top: 4vh;">
    <p style="margin: 0; padding: 8px 0 8px 0;" class="section_header">SHARE THIS CODE WITH OTHERS! <br> <?php echo isset($partyRoomCode) ? $partyRoomCode : ''; ?></p>
    </div>
